...
export function Toast({ message, tone = 'info', onClose }: ToastProps) {
  return (
    <div class="fixed inset-x-0 top-4 z-50 flex justify-center px-4" role="status" aria-live="polite" aria-atomic="true">
      <div
        class={`flex w-full max-w-md items-center gap-3 rounded-xl border bg-zinc-900/95 px-3 py-2 ${toneClass[tone]}`}
      >
